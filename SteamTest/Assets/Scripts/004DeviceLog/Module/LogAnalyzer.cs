...
namespace EscapeGame.Runtime.Log{
    ...
    #region Print message with trace
        ...
        /// Log 堆栈
        /// </summary>
        public static bool StackTraceMessages = true;

        /// <summary>
        /// Warning堆栈
        /// </summary>
        public static bool StackTraceWarnings = true;

        /// <summary>
        /// Error堆栈
        /// </summary>
        public static bool StackTraceErrors = true;
    ...
    #region Sequencer writer
        ...
        public static StreamWriter s_SequenceWriter{
            get{
    ...
    #region Analyzer writer
        ...
        public static StreamWriter s_AnalyzerWriter{
            get{
    ...
    #region Implemention functions
        ...
        public static void Setup(bool receiveLog){
            SetLogHandler();
            SetQuitFunc();
            ...
            s_SavePath  = $"{Application.persistentDataPath}/yunbinLog";
        ...
        /// 正常进入游戏
        /// </summary>
        private static void OnStandardStart(){
            LogHelper.Log(LogConst.GAME_START_KEY);
            DateTime date = DateTime.Now;
            LogHelper.Log(date.ToString(DATE_TIME_FORMAT_FULL));
            LogHelper.Log($"[设备信息]:{DeviceInfo.GetAllMemory()}");
        }
        ...
        /// 正常退出游戏
        /// </summary>
        private static void OnStandardQuit(){
